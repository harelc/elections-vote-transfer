...
TRANSFER_MATRIX = {
    'הליכוד':        {'הליכוד': 0.53, 'ביחד': 0.26, 'הציונות הדתית': 0.02, 'עוצמה יהודית': 0.09, 'ישר': 0.05, 'ש״ס': 0.03, 'יהדות התורה': 0.02},
    'יש עתיד':      {'ביחד': 0.50, 'ישר': 0.18, 'הדמוקרטים': 0.12, 'ישראל ביתנו': 0.15, 'הליכוד': 0.05},
    'הציונות הדתית': {'הציונות הדתית': 0.26, 'עוצמה יהודית': 0.40, 'ביחד': 0.15, 'הליכוד': 0.10, 'ש״ס': 0.05, 'ישר': 0.04},
    'המחנה הממלכתי': {'ביחד': 0.60, 'ישר': 0.15, 'הדמוקרטים': 0.05, 'ישראל ביתנו': 0.15, 'הליכוד': 0.05},
    'ש״ס':          {'ש״ס': 0.87, 'הליכוד': 0.03, 'עוצמה יהודית': 0.10},
    'יהדות התורה':  {'יהדות התורה': 0.87, 'ש״ס': 0.05, 'הליכוד': 0.02, 'עוצמה יהודית': 0.06},
    'ישראל ביתנו':  {'ישראל ביתנו': 0.50, 'ביחד': 0.25, 'ישר': 0.15, 'הליכוד': 0.10},
    'רע״ם':         {'הרשימה המשותפת': 0.97, 'הדמוקרטים': 0.03},
    'חד״ש-תע״ל':   {'הרשימה המשותפת': 0.85, 'הדמוקרטים': 0.15},
    'העבודה':       {'הדמוקרטים': 0.60, 'ביחד': 0.20, 'ישר': 0.15, 'ישראל ביתנו': 0.05},
    'מרצ':          {'הדמוקרטים': 0.70, 'ביחד': 0.15, 'ישר': 0.12, 'הרשימה המשותפת': 0.03},
