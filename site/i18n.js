...
(function () {
    ...
    const dict = {
        ...
        mandate_select_hint:   { he: 'לחצו על מפלגת יעד כדי לראות מאילו מפלגות הגיע שווי המנדטים שלה.', en: 'Click a target party to see where its seat-equivalent support came from.' },
        mandate_select_hint_future: { he: 'לחצו על מפלגת יעד כדי לראות מאילו מפלגות יגיע שווי המנדטים שלה.', en: 'Click a target party to see where its seat-equivalent support will come from.' },
        mandate_panel_title:   { he: 'מאיפה הגיעו המנדטים של {party}', en: 'Where {party} seats came from' },
        mandate_panel_title_future: { he: 'מאיפה יגיעו המנדטים של {party}', en: 'Where {party} seats will come from' },
        mandate_panel_summary: { he: '{seats} מנדטים · {votes} קולות בקלפיות המשותפות', en: '{seats} seats · {votes} votes in common precincts' },
        mandate_panel_below:   { he: 'לא עברה את אחוז החסימה · {votes} קולות בקלפיות המשותפות', en: 'Below threshold · {votes} votes in common precincts' },
        mandate_equiv_label:   { he: 'שווי מנדטים', en: 'Seat equivalent' },
        mandate_source_col:    { he: 'מקור', en: 'Source' },
        mandate_votes_col:     { he: 'קולות שעברו', en: 'Transferred votes' },
        mandate_votes_col_future: { he: 'קולות שיעברו', en: 'Projected transferred votes' },
        mandate_share_col:     { he: 'חלק ממפלגת היעד', en: 'Target share' },
        mandate_note:          { he: 'לחצו על מפלגת יעד אחרת כדי להחליף פירוק. זהו חישוב יחסי: חלק הקולות שהגיע מכל מקור כפול מספר המנדטים של מפלגת היעד. מנדטים לא מוקצים בפועל לפי מקור המצביעים.', en: 'Click another target party to switch the breakdown. This is a proportional calculation: each source vote share multiplied by the target party seats. Seats are not actually allocated by voter origin.' },
        mandate_note_future:   { he: 'לחצו על מפלגת יעד אחרת כדי להחליף פירוק. זהו חישוב יחסי: חלק הקולות שיגיע מכל מקור כפול מספר המנדטים של מפלגת היעד. מנדטים לא מוקצים בפועל לפי מקור המצביעים.', en: 'Click another target party to switch the breakdown. This is a proportional calculation: each projected source vote share multiplied by the target party seats. Seats are not actually allocated by voter origin.' },
    ...
    function renderNav(activeId) {
        ...
        const extraLinks = [
            ...
            { id: 'methodology', href: 'methodology.html', i18n: 'nav_methodology',  text: 'מתודולוגיה' },
