...
(function () {
    ...
    const dict = {
        ...
        threshold_votes_eq:    { he: '= {n} קולות', en: '= {n} votes' },
        threshold_cutoff:      { he: 'סף החסימה', en: 'Threshold' },
        ...
        votes_to_pass_threshold: { he: '+{n} למעבר אחוז החסימה', en: '+{n} to pass the threshold' },
        votes_to_drop_threshold: { he: '-{n} לירידה מתחת לאחוז החסימה', en: '-{n} to fall below the threshold' },
        gain_from:             { he: 'מ{party}', en: 'from {party}' },
        lose_to:               { he: 'ל{party}', en: 'to {party}' },
        seat_block_legend:     { he: 'כל משבצת = מנדט · מקווקו = שארית', en: 'Each block = 1 seat · dashed = remainder' },
        step:                  { he: 'צעד:', en: 'Step:' },
